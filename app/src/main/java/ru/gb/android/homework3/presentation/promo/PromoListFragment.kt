...
import ru.gb.android.homework3.presentation.promo.di.DaggerPromoListComponent
...
class PromoListFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        val appComponent=MarketSampleApp.getInstance().appComponent
        DaggerPromoListComponent.factory()
            .create(promoDependencies = appComponent)
            .inject(this)
